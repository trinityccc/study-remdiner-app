...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    setError("Demo mode: backend APIs are not available on GitHub Pages.");
    // Keep rendering the UI, but disable actions.
    $("welcomeEmail").textContent = "demo@github-pages";
    $("logoutBtn")?.setAttribute("disabled", "true");
    $("addReminderBtn")?.setAttribute("disabled", "true");
    $("reminderForm")?.classList.add("opacity-60", "pointer-events-none");
    return;
  }
